defmodule MimdbWeb.UserAuthTest do
  use MimdbWeb.ConnCase, async: true

  alias Mimdb.Users
  alias MimdbWeb.UserAuth
  import Mimdb.UsersFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, MimdbWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      MimdbWeb.Endpoint.subscribe(live_socket_id)
